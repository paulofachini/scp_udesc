<script>
    ...
    function importarMarcao() {
        $.post("<?php echo URL; ?>ImportacaoPonto/index", function (data) {
            if (data == '') {
                ...
                <div class="row">
                    <div class="col-lg-6" style="width: 100%">
                        <div style="margin-bottom: 100px">
                            <form action="<?php echo URL; ?>Marcacoes/edicao" method="post">
                                ...
                                <div style="width: 100px; margin-left: 20px;" class="pull-left">
                                    ...
                                    <select class="form-control" name="idPessoa">
                                        ...
                                        foreach ($arrPessoas as $pessoa) {
                                            echo '<option value="' . $pessoa->id . '" ' . ($pessoa->id == $pessoaSel ? 'selected' : '') . '>' . utf8_encode($pessoa->nome) . '</option>';
                                        }
                                        ?>
                                    </select>
                                </div>
                                ...
                                <div style="width: 100px; margin-left: 20px; padding-top: 20px;" class="pull-left">
                                    <input type="button" value="Importar Marcacao" class="btn btn-lg btn-success"
                                           onclick="importarMarcao();"/>
                                </div>
                            </form>
                        </div>

                        <form action="<?php echo URL; ?>Marcacoes/salvar" method="post">
                                ...
                                <?php
                                    ...
                                    foreach ($arrMarcaoes as $maracao) {
                                        ...
                                        if ($dia == $oldDia) {
                                            ...
                                            echo '<td><input  size="4" type="text" value="' . $hora->format('H:i') . '" name="' . $hora->format('Y_m_d') . '[]" /></td>';
                                        } else {
                                            if ($contDias != 0) {
                                                $intervalo = '';
                          ...
                          <tr>
                            ...
                            <td><input  size="4" type="text" value="' . $hora->format('H:i') . '" name="' . $hora->format('Y_m_d') . '[]" /></td>';
                    ...
                    ';
                            ...
                            <div style="width: 100px; margin-left: 20px; padding-top: 20px;">
